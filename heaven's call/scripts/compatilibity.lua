...
if EID then
	...
	EID:addCollectible(mod.Items.Terra, "#{{AppleHC}} Apples begin to spawn on the floor # Picked-up apples summon a giant snake that targets the most vulnerable enemy with the highest health # Apples on the floor grow up to stage 3; the higher the stage, the stronger the snake # The snake does not harm Isaac", "Retrograde Terra", "en_us")
	...
	EID:addCollectible(mod.SolarItems.Panspermia, "#{{ArrowUp}} {{Heart}} +1 Health # Damaging enemies charges blood # Overcharging blood drops half a red heart # Double tap the attack button to release a flesh whip, consuming one blood charge # The whip deals heavy damage and converts enemies into fleshlings #{{HealingRed}} 25% chance to heal half a heart every 30 seconds", "Panspermia", "en_us")
	EID:addCollectible(mod.SolarItems.Panspermia, "#{{ArrowUp}} {{Heart}} +1 de salud # Dañar enemigos carga sangre # Sobrecargar la sangre deja caer medio corazón rojo # Pulsa dos veces el botón de ataque para liberar un látigo de carne, consumiendo una carga de sangre # El látigo inflige gran daño y convierte a los enemigos en engendros de carne #{{HealingRed}} 25% de probabilidad de curar medio corazón cada 30 segundos", "Panspermia", "spa")
