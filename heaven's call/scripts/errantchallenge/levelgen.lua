...
function mod:GenerateEverchangerRoomsFromMapa(iteration)
                                ...
                                if newRoomIdx and level:MakeRedRoomDoor(roomIdx, slot) then
                                    ...
                                    elseif newChar == '|' then
                                        ...
                                        mod:scheduleForUpdate(function()
                                            ...
                                            --print(level:GetRoomByIdx(newRoomIdx, 0).ListIndex)
                                            --print(level:GetRoomByIdx(roomIdx, 0).ListIndex)
                                        end,1)
                                    ...
                                    table.insert(mod.minimaprooms, newRoomIdx)
                                    table.insert(mod.minimaprooms, newRoomIdx)
                                end
                            end
                            c = c + 1
