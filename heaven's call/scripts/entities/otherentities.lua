...
mod.PlayerPortraits = {
	[PlayerType.PLAYER_ISAAC] = {Portrait = "gfx/ui/stage/playerportrait_isaac.png", Name = "gfx/ui/boss/playername_01_isaac.png"},
	[PlayerType.PLAYER_MAGDALENE] = {Portrait = "gfx/ui/stage/playerportrait_magdalene.png", Name = "gfx/ui/boss/playername_02_magdalene.png"},
	[PlayerType.PLAYER_CAIN] = {Portrait = "gfx/ui/stage/playerportrait_cain.png", Name = "gfx/ui/boss/playername_03_cain.png"},
	[PlayerType.PLAYER_JUDAS] = {Portrait = "gfx/ui/stage/playerportrait_judas.png", Name = "gfx/ui/boss/playername_04_judas.png"},
	[PlayerType.PLAYER_BLUEBABY] = {Portrait = "gfx/ui/stage/playerportrait_bluebaby.png", Name = "gfx/ui/boss/playername_06_bluebaby.png"},
	[PlayerType.PLAYER_EVE] = {Portrait = "gfx/ui/stage/playerportrait_eve.png", Name = "gfx/ui/boss/playername_05_eve.png"},
	[PlayerType.PLAYER_SAMSON] = {Portrait = "gfx/ui/stage/playerportrait_samson.png", Name = "gfx/ui/boss/playername_07_samson.png"},
	[PlayerType.PLAYER_AZAZEL] = {Portrait = "gfx/ui/stage/playerportrait_azazel.png", Name = "gfx/ui/boss/playername_08_azazel.png"},
	[PlayerType.PLAYER_LAZARUS] = {Portrait = "gfx/ui/stage/playerportrait_lazarus.png", Name = "gfx/ui/boss/playername_10_lazarus.png"},
	[PlayerType.PLAYER_EDEN] = {Portrait = "gfx/ui/stage/playerportrait_eden.png", Name = "gfx/ui/boss/playername_09_eden.png"},
	[PlayerType.PLAYER_THELOST] = {Portrait = "gfx/ui/stage/playerportrait_thelost.png", Name = "gfx/ui/boss/playername_12_thelost.png"},
	[PlayerType.PLAYER_LAZARUS2] = {Portrait = "gfx/ui/stage/playerportrait_lazarus2.png", Name = "gfx/ui/boss/playername_10_lazarus.png"},
	[PlayerType.PLAYER_BLACKJUDAS] = {Portrait = "gfx/ui/stage/playerportrait_darkjudas.png", Name = "gfx/ui/boss/playername_04_judas.png"},
	[PlayerType.PLAYER_LILITH] = {Portrait = "gfx/ui/stage/playerportrait_lilith.png", Name = "gfx/ui/boss/playername_13_lilith.png"},
	[PlayerType.PLAYER_KEEPER] = {Portrait = "gfx/ui/stage/playerportrait_keeper.png", Name = "gfx/ui/boss/playername_14_thekeeper.png"},
	[PlayerType.PLAYER_APOLLYON] = {Portrait = "gfx/ui/stage/playerportrait_apollyon.png", Name = "gfx/ui/boss/playername_15_apollyon.png"},
	[PlayerType.PLAYER_THEFORGOTTEN] = {Portrait = "gfx/ui/stage/playerportrait_theforgotten.png", Name = "gfx/ui/boss/playername_16_theforgotten.png"},
	[PlayerType.PLAYER_THESOUL] = {Portrait = "gfx/ui/stage/playerportrait_theforgotten.png", Name = "gfx/ui/boss/playername_16_theforgotten.png"},
	[PlayerType.PLAYER_BETHANY] = {Portrait = "gfx/ui/stage/playerportrait_bethany.png", Name = "gfx/ui/boss/playername_01x_bethany.png"},
	[PlayerType.PLAYER_JACOB] = {Portrait = "gfx/ui/stage/playerportrait_jacob.png", Name = "gfx/ui/boss/playername_02x_jacob_esau.png"},
	[PlayerType.PLAYER_ESAU] = {Portrait = "gfx/ui/stage/playerportrait_jacob.png", Name = "gfx/ui/boss/playername_02x_jacob_esau.png"},

	[PlayerType.PLAYER_ISAAC_B] = {Portrait = "gfx/ui/stage/playerportrait_isaac_b.png", Name = "gfx/ui/boss/playername_01_isaac.png"},
	[PlayerType.PLAYER_MAGDALENE_B] = {Portrait = "gfx/ui/stage/playerportrait_magdalene_b.png", Name = "gfx/ui/boss/playername_02_magdalene.png"},
	[PlayerType.PLAYER_CAIN_B] = {Portrait = "gfx/ui/stage/playerportrait_cain_b.png", Name = "gfx/ui/boss/playername_03_cain.png"},
	[PlayerType.PLAYER_JUDAS_B] = {Portrait = "gfx/ui/stage/playerportrait_judas_b.png", Name = "gfx/ui/boss/playername_04_judas.png"},
	[PlayerType.PLAYER_BLUEBABY_B] = {Portrait = "gfx/ui/stage/playerportrait_bluebaby_b.png", Name = "gfx/ui/boss/playername_06_bluebaby.png"},
	[PlayerType.PLAYER_EVE_B] = {Portrait = "gfx/ui/stage/playerportrait_eve_b.png", Name = "gfx/ui/boss/playername_05_eve.png"},
	[PlayerType.PLAYER_SAMSON_B] = {Portrait = "gfx/ui/stage/playerportrait_samson_b.png", Name = "gfx/ui/boss/playername_07_samson.png"},
	[PlayerType.PLAYER_AZAZEL_B] = {Portrait = "gfx/ui/stage/playerportrait_azazel_b.png", Name = "gfx/ui/boss/playername_08_azazel.png"},
	[PlayerType.PLAYER_LAZARUS_B] = {Portrait = "gfx/ui/stage/playerportrait_lazarus_b.png", Name = "gfx/ui/boss/playername_10_lazarus.png"},
	[PlayerType.PLAYER_EDEN_B] = {Portrait = "gfx/ui/stage/playerportrait_eden.png", Name = "gfx/ui/boss/playername_09_eden.png"},
	[PlayerType.PLAYER_THELOST_B] = {Portrait = "gfx/ui/stage/playerportrait_thelost_b.png", Name = "gfx/ui/boss/playername_12_thelost.png"},
	[PlayerType.PLAYER_LILITH_B] = {Portrait = "gfx/ui/stage/playerportrait_lilith_b.png", Name = "gfx/ui/boss/playername_13_lilith.png"},
	[PlayerType.PLAYER_KEEPER_B] = {Portrait = "gfx/ui/stage/playerportrait_keeper_b.png", Name = "gfx/ui/boss/playername_14_thekeeper.png"},
	[PlayerType.PLAYER_APOLLYON_B] = {Portrait = "gfx/ui/stage/playerportrait_apollyon_b.png", Name = "gfx/ui/boss/playername_15_apollyon.png"},
	[PlayerType.PLAYER_THEFORGOTTEN_B] = {Portrait = "gfx/ui/stage/playerportrait_theforgotten_b.png", Name = "gfx/ui/boss/playername_16_theforgotten.png"},
	[PlayerType.PLAYER_BETHANY_B] = {Portrait = "gfx/ui/stage/playerportrait_bethany_b.png", Name = "gfx/ui/boss/playername_01x_bethany.png"},
	[PlayerType.PLAYER_JACOB_B] = {Portrait = "gfx/ui/stage/playerportrait_jacob_b.png", Name = "gfx/ui/boss/playername_02x_jacob.png"},
	[PlayerType.PLAYER_LAZARUS2_B] = {Portrait = "gfx/ui/stage/playerportrait_lazarus_b_dead.png", Name = "gfx/ui/boss/playername_10_lazarus.png"},
	[PlayerType.PLAYER_JACOB2_B] = {Portrait = "gfx/ui/stage/playerportrait_jacob_b.png", Name = "gfx/ui/boss/playername_02x_jacob.png"},
	[PlayerType.PLAYER_THESOUL_B] = {Portrait = "gfx/ui/stage/playerportrait_theforgotten_b.png", Name = "gfx/ui/boss/playername_16_theforgotten.png"},
}
